...
countriesOnlyName.forEach((value: string) => {
  console.log(value);
});
...
const upperCasedCountries: string[] = countriesOnlyName.map((value: string) => {
...
const countryLengths: number[] = countriesOnlyName.map((value: string) => {
  return value.length;
});
...
const countriesContainingLand: string[] = countriesOnlyName.filter(
  (value: string) => {
...
const countriesHavingSixCharacter: string[] = countriesOnlyName.filter(
  (value: string) => {
...
const countriesHavingMoreThanSixCharacter: string[] = countriesOnlyName.filter(
  (value: string) => {
    return value.length >= 6 ? true : false;
  },
);
...
const countriesStartWithE: string[] = countriesOnlyName.filter(
  (value: string) => {
...
let allCountries: string =
  countriesOnlyName.reduce(
    (previousValue: string, currentValue: string, currentIndex: number) => {
      if (currentIndex == countriesOnlyName.length - 1) {
...
const isAllCountriesContainWordOfLand: boolean = countriesOnlyName.every(
  (value: string) =>
...
const firstCountryContainingOnlySixLetter: string | undefined =
  countriesOnlyName.find((value: string) => (value.length == 7 ? true : false));
...
const firstCountryIndexContainingOnlySixLetter: number | undefined =
  countriesOnlyName.findIndex((value: string) =>
    value.length == 7 ? true : false,
  );
...
const IndexOfNorway: number = countriesOnlyName.findIndex((value: string) =>
...
const IndexOfRussia: number = countriesOnlyName.findIndex((value: string) =>
