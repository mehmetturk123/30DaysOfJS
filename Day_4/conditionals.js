...
if(userInput != null)
{
    switch (userInput.toLowerCase()) {
        case('monday'): case('tuesday'): case('wednesday'): case('thursday'): case('friday'):
            window.alert(`${userInput.toLowerCase().charAt(0).toUpperCase()} is a working day.`);
            break;
        case('saturday'): case('sunday'):
            window.alert(`${userInput.toLowerCase().charAt(0).toUpperCase()} is a weekend.`);
            break;
        default:
...
const userYear = window.prompt('Enter the year:');
const userMonth = window.prompt('Enter a month:');
if (userMonth != null && userYear != null) {
    ...
    if (Number.isNaN(userYearNumber)) {
        ...
        const userMonthArray = userMonth.toLowerCase().split('');
        userMonthArray[0] = userMonthArray[0].toUpperCase();
        const tempString = userMonthArray.join('');
