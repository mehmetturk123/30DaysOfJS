// Exercise: Level 2
export{};
const helpString: string = 'help';
const quote: string = 'There is no exercise better for the heart than reaching down and lifting people up.';
console.log(`The quote '${quote}' by John Holmes teaches us to ${helpString} one another.`);
const stringExample: string = "Love is not patronizing and charity isn't about pity, it is about love. Charity and love are the same -- with charity you give love, so don't just give money but reach out your hand instead.";
...
const str0: string = 'python', str1: string = 'jargon';
...
${randomNumber(128)} ${randomNumber(128)} ${randomNumber(128)} ${randomNumber(128)} ${randomNumber(128)}\n\
${randomNumber(128)} ${randomNumber(128)} ${randomNumber(128)} ${randomNumber(128)} ${randomNumber(128)}`);
const str5: string = 'You cannot end a sentence with because because because is a conjunction';
