// Exercise: Level 3
export{};
const str0: string = 'Love is the best thing in this world. Some found their love and some are still looking for their love.';
...
const str6: string = 'He earns 5000 euro from salary per month, 10000 euro annual bonus, 15000 euro online courses per month.';
const arr: RegExpMatchArray | null = str6.match(/\d+/g);
